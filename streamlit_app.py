...
def sign_predict(image):
    ...
    a = int("".join(s))
    Y_pred = "Predicted Traffic🚦Sign is: " +labels_dict[a]
    return Y_pred
...
def main():
    ...
    if image_usr is not None:
        ...
        # Make prediction
        prediction_label = sign_predict(image_usr)
    ...
    st.markdown("""
    The app uses an implementation of Convolutional Neural Network. 
